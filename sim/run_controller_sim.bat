...
setlocal
echo =========================================================
echo [LoongArch SoC] Starting Vivado Simulation for Controller...
echo =========================================================
...
call "%VIVADO_BIN%\xvlog.bat" ..\rtl\core\controller.v ..\tb\tb_controller.v
if errorlevel 1 (
...
call "%VIVADO_BIN%\xelab.bat" -debug typical -top tb_controller -snapshot tb_controller_snap
if errorlevel 1 (
...
call "%VIVADO_BIN%\xsim.bat" tb_controller_snap -R
