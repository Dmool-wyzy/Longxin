...
setlocal
echo =========================================================
echo [LoongArch SoC] Starting Vivado Simulation for ALU...
echo =========================================================
...
call "%VIVADO_BIN%\xvlog.bat" ..\rtl\core\alu.v ..\tb\tb_alu.v
if errorlevel 1 (
...
call "%VIVADO_BIN%\xelab.bat" -debug typical -top tb_alu -snapshot tb_alu_snap
if errorlevel 1 (
...
call "%VIVADO_BIN%\xsim.bat" tb_alu_snap -R
