...
setlocal
echo =========================================================
echo [LoongArch SoC] Starting Vivado Simulation for PC...
echo =========================================================
...
call "%VIVADO_BIN%\xvlog.bat" ..\rtl\core\pc.v ..\tb\tb_pc.v
if errorlevel 1 (
...
call "%VIVADO_BIN%\xelab.bat" -debug typical -top tb_pc -snapshot tb_pc_snap
if errorlevel 1 (
...
call "%VIVADO_BIN%\xsim.bat" tb_pc_snap -R
